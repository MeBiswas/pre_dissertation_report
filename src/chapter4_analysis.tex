...
This chapter describes the methodology adopted to design, train, and evaluate machine learning models for credit card fraud detection. All experiments were conducted using the publicly available European Credit Card Fraud Dataset, which contains 284{,}807 transactions recorded over two days in September 2013. Of these, only 492 are fraudulent, representing an extreme imbalance of 0.172\%. This imbalance makes the dataset ideal for evaluating classification algorithms under realistic fraud-detection constraints.

A diverse set of machine learning algorithms was selected to assess their performance under different feature-processing and resampling strategies. The models used in this study include Logistic Regression (LR), Naïve Bayes (NB), Decision Tree (DT), Random Forest (RF), Support Vector Machine (SVM), k-Nearest Neighbors (KNN), XGBoost, and LightGBM. These models provide a comprehensive comparison across linear, probabilistic, tree-based, ensemble, and distance-based approaches.
